...
#     st.session_state.chiper = Fernet(st.session_state.KEY)
...
# def encrypt_data(text, passkey):
#     return st.session_state.chiper.encrypt(text.encode()).decode()
...
#         if value["encrypted_text"] == encrypted_text and value["passkey"] == hashed_passkey:
#             st.session_state.failed_attempts = 0
#             return st.session_state.chiper.decrypt(encrypted_text.encode()).decode()
...
#                     st.warning("🔒 Too many failed attempts! Redirecting to Login Page.")
#                     st.session_state.failed_attempts = 0  # reset before rerun
...
#             st.session_state.failed_attempts = 0
#             st.success("✅ Reauthorized successfully! Redirecting to Retrieve Data...")
#             st.experimental_set_query_params(page="Retrieve Data")
